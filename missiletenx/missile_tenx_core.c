...
static int missile_tenx_probe(struct usb_interface *interface,
...
static int missile_tenx_set_endpoint(struct usb_interface *interface)
{
	int i;
...
*******************************************************************************/
static void __init missile_driver_set(void)
{
 ...
 */
static int __init missile_tenx_init(void)
{
	int result;
	missile_driver_set();
 ...
 * que dans missile_tenx_init/missile_tenx_exit. Si oui, utiliser un writer_lock
 */
static void __exit missile_tenx_exit(void)
{
